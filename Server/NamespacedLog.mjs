"use strict";
// I copy this file across lots of different repos

import a from './primitives/Ansi.mjs';
import l from './primitives/Log.mjs';
...
function hash_numeric(str) {
	let hash = 435823; // Should be 0, but could be any number really
